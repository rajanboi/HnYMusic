...
async def thumb_init(videoid):
    try:
        if os.path.isfile(f"DORAROBOT/Cache/{videoid}.jpg"):
            return f"DORAROBOT/Cache/{videoid}.jpg"
        ...
        if 1==1:
            ...
            circle = Image.open("DORAROBOT/Utilities/Circle.png")
            ...
            image4.text((670, 150), "DORA ROBOT", fill="white", font = font2, stroke_width=2, stroke_fill="white", align ="left") 
